...
export default function JsonLd() {
  const organizationSchema = {
    ...
    "image": "https://morotech.digital/about-image.webp",
    "description":
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "O investimento varia de acordo com a complexidade, as funcionalidades e os objetivos do projeto. Após entender suas necessidades, apresentamos um orçamento sob medida.",
        },
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "Landing pages duram em média de 7 a 15 dias para entrega, enquanto sites institucionais e sistemas personalizados complexos podem levar de 30 a 60 dias. Apresentamos um cronograma detalhado antes do início.",
        },
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "Sim. Todos os nossos projetos são desenvolvidos seguindo as melhores práticas de SEO (Otimização para Motores de Busca) estrutural. Isso garante que o Google e outros buscadores consigam rastrear, indexar e posicionar suas páginas de forma otimizada.",
        },
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "Com certeza. Desenvolvemos com foco total na experiência do usuário em múltiplos dispositivos. Seu site funcionará de forma impecável e adaptada em smartphones, tablets, notebooks e computadores.",
        },
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "Sim. Desenvolvemos sistemas sob medida de acordo com as necessidades específicas do seu modelo de negócio, como painéis administrativos, áreas de membros, automatizações de processos e integrações diversas.",
        },
      },
      {
        "@type": "Question",
